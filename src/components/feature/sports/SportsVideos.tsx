...
} from "../../../redux/api/sports/sportsApis";
...
export default function SportsVideos() {
  ...
  const [newSport, setNewSport] = useState<
    Omit<SportsVideo, "_id" | "createdAt" | "updatedAt">
  >({
    title: "",
    description: "",
    thumbnail: "",
  ...
  const handleStartEdit = (video: SportsVideo) => {
...
console.log("Her to update",newSport);
    try {
        ...
        {editingVideo && (
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                setNewSport({ ...newSport, title: e.target.value })
              }
            />
            ...
            <input
              ...
              value={newSport.src}
              onChange={(e) =>
                setNewSport({ ...newSport, src: e.target.value })
              }
            />
            ...
            <select
              ...
              value={newSport.type}
              onChange={(e) =>
                setNewSport({ ...newSport, type: e.target.value })
              }
            >
        ...
        {isAddOpen && (
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                setNewSport({ ...newSport, thumbnail: e.target.value })
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                setNewSport({ ...newSport, order: Number(e.target.value) })
              }
            />
